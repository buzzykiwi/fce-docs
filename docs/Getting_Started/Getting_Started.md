...
8. Zapier displays the data from one of the items retrieved. This data will be available as you set up subsequent Actions in the Zap, but will be replaced by "live" data when the Zap runs live. You can switch to a different sample by clicking on "SQL Records Search Results C" and selecting a different item.<p align="center"><img alt="Post-test data" src="../../img/post-test-data.png" width="500px"></p>
